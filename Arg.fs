...
type ArgParser() =
   static let getUsage specs u =  
     ...
     List.iter (fun (arg:ArgInfo) ->
       ...
       | (s, (Arg.Unit _ | Arg.Set _ | Arg.Clear _), helpText) -> pstring "\t"; pstring s; pstring ": "; pendline helpText
       | (s, Arg.String _, helpText) -> pstring "\t"; pstring s; pstring " <string>: "; pendline helpText
       | (s, Arg.Int _, helpText) -> pstring "\t"; pstring s; pstring " <int>: "; pendline helpText
       | (s, Arg.Float _, helpText) ->  pstring "\t"; pstring s; pstring " <float>: "; pendline helpText
       | (s, Arg.Rest _, helpText) -> pstring "\t"; pstring s; pstring " ...: "; pendline helpText)
       specs;
